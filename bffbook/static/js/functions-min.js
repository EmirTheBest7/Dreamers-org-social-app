! function (t, e, i, n) {
    ...
    function t(t) {
        var n = $(".lnav").find(".is-active"),
            s = $(".lnav").children().index(n),
            r = $(".lnav").children().length - 1,
            o = 0;
    ...
    function e(t) {
        $(".lnav, .outer-nav").children().removeClass("is-active"), $(".lnav").children().eq(t).addClass("is-active"), $(".outer-nav").children().eq(t).addClass("is-active")
    }
    ...
    $(this).on("mousewheel DOMMouseScroll", function (e) {
    ...
    }), $(".lnav li, .outer-nav li").click(function () {
        ...
        var t = $(".lnav").find(".is-active"),
            n = $(".lnav").children().index(t),
            s = $(".lnav").children().length - 1,
            r = s;
        e(s), i(n, r, s)
    });
